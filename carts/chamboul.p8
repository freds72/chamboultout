...
function title_state()
	...
	return
		...
		function()		
			...
			if(btn()!=0) music(-1,250) switch_state(play_state)
		end,
		function()
...
function gameover_state(score)
	...
	local scores,pos,colors,rank={},split"-20,140,-20,140,-20",split"3,3,3,8,8,8",split"TH ,TH ,RD ,ND ,ST "
	...
	return
		...
		function()
			...
			if(btn()!=0) music(-1,250) switch_state(title_state)
		end,
		-- draw
		function()
			_cam:draw_objects(things)
...
function play_state()
	...
	states={
		...
		score=function()
			ttl=0
			-- fallen pins?
			local tmp,cleared=active_pins,true
			active_pins={}
			...
			if cleared then				
				...
				score_txt=score>0 and score or "-"
		...
		game_over=function()
			ttl=15
			switch_state(gameover_state,score)
			return function() end
		end
	}
	-- initial state
	...
	return
		...
		function()
			...
			for i,score in ipairs(scores) do
				...
				map(0,i==5 and 3 or 2,0,y-2,3,1)
				print(score,2,y,7)
				y+=8
			end			
