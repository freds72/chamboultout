...
function make_cam()
	...
	return {
		track=function(self,o)
			...
			local target=v_add(o.pos,v_up,8)
...
function draw_ground()
	...
	for i=127,0,-1 do
		...
		if (vu[2]<-k_small) then 
			...
			tline(0,i,127,i,tx,tz,(vr[1]*kr+x-tx)>>7,(vr[3]*kr+z-tz)>>7)
		end
	end
...

...

...

...

